/**
 * pages/InterviewComplete.jsx – "Interview Complete" screen shown after all answers are submitted.
 * Matches reference site's completion screen: clean white card, thank-you message, no AI scores visible.
 */
