            ...
            <div className="max-w-6xl mx-auto px-6 py-10">
                ...
                >
                    ...
                    <p className="text-brand-300 text-sm text-center mb-6 max-w-md mx-auto">
                        Our AI reads your resume and crafts <span className="text-brand-200 font-semibold">5 personalised questions</span> based on your skills and experience.
                    </p>
                                    ...
                                    {skillsDetected.length > 0 && (
                                        <div className="flex flex-wrap gap-1.5 justify-center max-w-lg mt-1">
                                            {skillsDetected.map((skill) => (
                                                <span key={skill} className="text-xs px-2.5 py-1 rounded-full bg-brand-800/60 border border-brand-600/40 text-brand-200 font-medium">
                                                    {skill}
                                                </span>
                                            ))}
                                        </div>
                    ...
                    <div className="flex flex-col items-center gap-2">
                        <button
                            ...
                            disabled={!sessionId}
                            className="inline-flex items-center gap-2 bg-gradient-to-r from-brand-600 to-purple-600 hover:from-brand-500 hover:to-purple-500 disabled:opacity-40 disabled:cursor-not-allowed text-white font-semibold px-10 py-3 rounded-xl transition-all duration-300 hover:scale-105 disabled:hover:scale-100">
